...
const double dt = 0.01; //send desired-state messages at fixed rate, e.g. 0.02 sec = 50Hz
...
const double path_move_tol = 0.1; // if path points are within 1cm, fuggidaboutit
