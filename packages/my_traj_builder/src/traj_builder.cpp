...
//For this to work we need to somehow get the current speed, to know where to decelerate from
//does vec_of_states have the current states in it or is it always empty 
